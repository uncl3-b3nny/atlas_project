...
# 0. A5 hierarchy for assemblies
# 1. ancestry gem to allow assemblies to have assemblies. Use debts and credits to track productivity
...
# 3. build all conventional join tables (huge list of tables, and lots of coding) Can I just make each join object belong to its parent join object?

#dealing with the assemblies within assemblies is not an urgent problem. I never should have started on it. 
